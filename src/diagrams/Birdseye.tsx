...
const BLOCKS: Block[] = [
  ...
  { x: 900, y: 80, w: 230, title: "Boston atlas CLI", a: "10 Aug front door", b: "not the July Tauri desk", stroke: "#34d399" },
  ...
  { x: 810, y: 194, w: 150, title: "intent sealed", a: "4 Aug · two drives only", stroke: "#34d399" },
  ...
  { x: 1030, y: 416, w: 100, title: "L2 factory", a: "13 Aug · not live", stroke: "#fbbf24", dash: true },
